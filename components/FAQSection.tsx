...
const FAQS = [
  ...
  },
  {
    ...
    a: "בהחלט. אם אתם מעדיפים שלא להתעסק בשום דבר טכני, אנחנו נדאג לכל — הגדרת האירוע, עיצוב הגלריה, הפעלת ה-Live Wall וה-Clink Mosaic, וניהול שוטף לאורך כל האירוע. אתם נהנים, אנחנו מטפלים בכל השאר.",
  },
];
