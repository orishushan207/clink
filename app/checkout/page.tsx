...
const ONETIME_PLANS = [
  {
    ...
    emoji: "🎉",
    price: 389,
    tagline: "הכל שצריך לאירוע מושלם",
    features: [
      "גלריה שיתופית חיה",
  ...
  },
  {
    ...
    emoji: "✨",
    price: 589,
    tagline: "עם Clink פסיפס — כולל פיצ׳ר הכי מבוקש",
    features: [
      "גלריה שיתופית חיה",
      "Live Wall למסך האולם 🔴",
      "Clink פסיפס 🎨",
  ...
  },
  {
    ...
    emoji: "👑",
    price: 899,
    tagline: "חוויה VIP מושלמת — עם כל הפיצ׳רים",
    features: [
      "גלריה שיתופית חיה",
      "Live Wall למסך האולם 🔴",
      "Clink פסיפס 🎨",
...
const SUB_PLANS = [
  {
    ...
    emoji: "🎉",
    price: 699,
    tagline: "עד 4 אירועים / חודש — הכל שצריך",
    features: [
      "עד 4 אירועים בחודש",
      "גלריה שיתופית חיה",
      "Live Wall למסך האולם 🔴",
      "QR code ייחודי לכל אירוע",
      "יצירת קליפ אוטומטי",
      "לייקים, תגובות וצ׳אט",
      "ניהול ואישור תמונות",
      "הורדת ZIP בסוף",
  ...
  },
  {
    ...
    emoji: "✨",
    price: 1200,
    tagline: "עד 4 אירועים / חודש — עם Clink פסיפס",
    features: [
      "עד 4 אירועים בחודש",
      "גלריה שיתופית חיה",
      "Live Wall למסך האולם 🔴",
  ...
  },
  {
    ...
    emoji: "👑",
    price: 1899,
    tagline: "עד 4 אירועים / חודש — חוויה VIP מלאה",
    features: [
      "עד 4 אירועים בחודש",
      "גלריה שיתופית חיה",
      "Live Wall למסך האולם 🔴",
