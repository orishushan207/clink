...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-party-bg overflow-x-hidden" dir="rtl">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-black/75 via-black/60 to-party-bg pointer-events-none" />
            ...
            <div className="text-right order-2 md:order-1">
              ...
              <div className="flex items-center gap-3 mb-5">
                <div className="flex -space-x-2 rtl:space-x-reverse">
                  {["🧑‍🦱","👩","🧔","👩‍🦳","🙋"].map((e, i) => (
                    <div key={i} className="w-8 h-8 rounded-full bg-gradient-to-br from-party-gold to-amber-500 border-2 border-party-bg flex items-center justify-center text-sm">
                      {e}
                    </div>
                  ))}
                </div>
              ...
              <div className="space-y-2 mb-8">
                {[
                  ...
                  <div key={q} className="grid items-center gap-2" style={{ gridTemplateColumns: "auto 1fr" }}>
                    <div className="w-5 h-5 rounded-full bg-party-gold/20 border border-party-gold/50 flex items-center justify-center flex-shrink-0">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <Link
                  href="/admin/login"
                  className="flex items-center justify-center gap-2 border border-white/10 hover:border-white/20 text-gray-300 hover:text-white font-medium text-base px-7 py-4 rounded-2xl transition-all"
                >
              ...
              <div className="flex flex-wrap gap-4 mt-6">
                {["בלי אפליקציה", "בלי הרשמה", "עובד מכל מכשיר"].map(b => (
                  <span key={b} className="flex items-center gap-1.5 text-sm text-gray-500">
              ...
              <div className="flex items-center gap-3 mt-5">
                <span className="text-xs text-gray-600">עקבו אחרינו:</span>
                <a
                  href="https://www.instagram.com/clink.il?igsh=MTVkd2RyeXVjMGdlbQ%3D%3D&utm_source=qr"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center w-9 h-9 rounded-xl bg-gradient-to-br from-[#833ab4]/20 via-[#fd1d1d]/20 to-[#fcb045]/20 border border-white/10 hover:border-white/20 transition-all"
                  title="Instagram"
                >
      ...
      <section className="max-w-3xl mx-auto px-6 py-16">
        <div className="text-center mb-10">
          <p className="text-gray-500 text-sm uppercase tracking-widest mb-3">כי כל אירוע ראוי לזיכרון אמיתי</p>
          <h2 className="text-2xl sm:text-3xl font-bold text-white">
            Clink הופכת את האורחים שלכם
            <span className="gradient-text"> לחלק מהסיפור</span>
          </h2>
          <p className="text-gray-400 text-sm mt-3 max-w-lg mx-auto">לא עוד תמונות שמפוזרות על 50 טלפונים — אלא חוויה חיה שכולם חלק ממנה, מהרגע הראשון ועד הסוף</p>
        </div>

        <div className="grid sm:grid-cols-2 gap-4">
          {/* Before */}
          <div className="bg-red-500/5 border border-red-500/20 rounded-2xl p-5">
            <p className="text-red-400 text-xs font-semibold uppercase tracking-wider mb-3">בלי Clink</p>
          ...
          <div className="bg-emerald-500/5 border border-emerald-500/20 rounded-2xl p-5">
            <p className="text-emerald-400 text-xs font-semibold uppercase tracking-wider mb-3">עם Clink</p>
            <ul className="space-y-2.5">
              {[
      ...
      <section className="max-w-2xl mx-auto px-6 py-16">
        <h2 className="text-2xl font-bold text-white text-center mb-2">איך זה עובד?</h2>
        <p className="text-gray-500 text-center text-sm mb-10">פשוט כמו לסרוק ברקוד</p>
        ...
        <div className="space-y-3">
          {[
            ...
            <div key={item.step} className="flex items-start gap-4 p-4 bg-party-surface border border-party-border rounded-2xl">
              <div className="flex-shrink-0 w-9 h-9 rounded-xl bg-gradient-to-br from-party-gold/20 to-amber-500/20 border border-party-gold/20 flex items-center justify-center">
                <span className="text-xs font-bold text-yellow-400">{item.step}</span>
              </div>
              <div>
                <h3 className="font-bold text-white text-sm flex items-center gap-2">{item.emoji} {item.title}</h3>
      ...
      <section className="max-w-2xl mx-auto px-6 pb-16">
        <h2 className="text-2xl font-bold text-white text-center mb-8">מה מקבלים?</h2>
        <div className="grid grid-cols-3 gap-3">
          {[
            { icon: QrCode,   color: "text-yellow-400", bg: "bg-party-gold/10", title: "QR Code ייחודי",      desc: "כל אירוע מקבל QR משלו" },
            { icon: Camera,   color: "text-amber-400",   bg: "bg-amber-500/10",   title: "העלאה קלה",          desc: "תמונות וסרטונים ישירות מהמצלמה" },
            { icon: Zap,      color: "text-amber-400",  bg: "bg-amber-500/10",  title: "זמן אמת",            desc: "כל תמונה וסרטון מופיעים מיד לכולם" },
            ...
            <div key={title} className="p-3 bg-party-surface border border-party-border rounded-2xl hover:border-party-gold/20 transition-all flex flex-col h-44">
      ...
      {/* ─── MOSAIC SPOTLIGHT ─── */}
      <section className="max-w-3xl mx-auto px-6 py-16">
        <div className="relative overflow-hidden rounded-3xl border border-purple-500/30 bg-gradient-to-br from-purple-900/30 via-party-surface to-party-bg p-8 sm:p-10">
          {/* Background glow */}
          <div className="absolute -top-20 -right-20 w-64 h-64 bg-purple-600/10 rounded-full blur-3xl pointer-events-none" />
          <div className="absolute -bottom-16 -left-16 w-48 h-48 bg-party-gold/10 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="relative grid sm:grid-cols-2 gap-8 items-center" dir="rtl">
            ...
            <div>
              ...
              <p className="text-purple-300 text-sm font-semibold leading-snug">
            ...
            <div className="flex justify-center">
              <div className="relative w-52 h-52 sm:w-64 sm:h-64">
                ...
                <div className="w-full h-full rounded-2xl overflow-hidden border border-purple-500/30 shadow-2xl shadow-purple-500/20">
                  <div className="grid grid-cols-6 grid-rows-6 w-full h-full gap-px bg-purple-900/30">
                    {Array.from({ length: 36 }).map((_, i) => {
                      ...
                      return (
                        <div
                          ...
                          style={{
                            background: `hsl(${(i * 47) % 360}, 40%, ${15 + (i % 3) * 5}%)`,
                          }}
                        >
                ...
                {/* Overlay label */}
                <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 bg-purple-600/90 backdrop-blur-sm text-white text-xs font-bold px-3 py-1 rounded-full shadow-lg whitespace-nowrap border border-purple-400/30">
      ...
      <section className="max-w-3xl mx-auto px-6 pb-16">
        <div className="relative overflow-hidden rounded-3xl border border-party-gold/30 bg-gradient-to-br from-amber-900/20 via-party-surface to-party-bg p-8 sm:p-10">
          <div className="absolute -top-20 -left-20 w-64 h-64 bg-amber-600/10 rounded-full blur-3xl pointer-events-none" />

          <div className="relative grid sm:grid-cols-2 gap-8 items-center" dir="rtl">
            {/* Text */}
            <div>
              <div className="inline-flex items-center gap-2 bg-red-500/15 border border-red-500/30 rounded-full px-3 py-1 mb-4">
                <span className="w-2 h-2 rounded-full bg-red-400 animate-pulse" />
                <span className="text-red-300 text-sm font-bold">Live Wall 🔴</span>
              </div>
              <h2 className="text-2xl sm:text-3xl font-black text-white leading-tight mb-3">
                הרגע הכי כיף?<br />
            ...
            <div className="flex justify-center">
              <div className="relative w-52 h-52 sm:w-64 sm:h-60 rounded-2xl overflow-hidden border border-party-gold/30 shadow-2xl shadow-amber-500/20 bg-black flex flex-col items-center justify-center gap-3">
                ...
                <div className="grid grid-cols-3 gap-1.5 px-3">
                  {["🥂","📸","💃","🎉","💍","🕺"].map((e, i) => (
                    <div key={i} className="w-12 h-12 rounded-lg bg-party-surface border border-party-gold/20 flex items-center justify-center text-xl">
                      {e}
                    </div>
                  ))}
                </div>
                <div className="text-xs text-yellow-400 font-semibold animate-pulse">+תמונה חדשה 🔥</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-12">
        <div className="text-center mb-8 px-6">
          <h2 className="text-2xl font-bold text-white mb-2">מה אומרים עלינו?</h2>
          <p className="text-gray-500 text-sm">אנשים שכבר חוו את Clink באירועים שלהם</p>
        </div>
        <div className="flex gap-4 overflow-x-auto px-6 pb-4 snap-x snap-mandatory scrollbar-hide" style={{ scrollbarWidth: "none" }}>
          {[
            ...
            <div key={name} className="bg-party-surface border border-party-border rounded-2xl p-5 flex flex-col gap-3 flex-shrink-0 w-72 snap-start">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-party-gold/30 to-amber-500/30 border border-party-gold/20 flex items-center justify-center text-xl flex-shrink-0">
                  {avatar}
                </div>
                <div>
      ...
      <section className="max-w-xl mx-auto px-6 py-10 pb-20 text-center">
        <div className="bg-party-gradient-soft border border-party-gold/20 rounded-3xl p-8">
          ...
          <p className="text-gray-600 text-xs mt-4">תשלום חד פעמי · ללא מנוי · מוכן בשניות</p>
        </div>
      </section>

      {/* ─── FOOTER ─── */}
      <footer className="border-t border-party-border py-8 px-6 text-center text-gray-600 text-sm">
        ...
        {/* Contact */}
        <div className="mb-5">
          <p className="text-gray-400 text-sm mb-3">לפרטים נוספים — צרו קשר</p>
          <div className="flex items-center justify-center gap-3 flex-wrap">
            ...
            <a
              ...
              className="inline-flex items-center justify-center w-12 h-12 bg-party-gold/10 hover:bg-party-gold/20 border border-party-gold/30 rounded-xl transition-all"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-br from-[#833ab4]/15 via-[#fd1d1d]/15 to-[#fcb045]/15 border border-white/10 hover:border-white/20 rounded-xl transition-all"
              title="Instagram"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center w-12 h-12 bg-white/5 border border-white/10 hover:border-white/20 rounded-xl transition-all"
              title="TikTok"
            >
              <svg className="w-6 h-6 text-white" viewBox="0 0 24 24" fill="currentColor">
                <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34l-.01-7.38a8.27 8.27 0 004.84 1.55V6.03a4.85 4.85 0 01-1.07-.34z"/>
        ...
        <div className="flex items-center justify-center gap-4 mt-2">
          <Link href="/terms" className="text-gray-600 hover:text-gray-400 transition-colors text-xs">תנאי שימוש</Link>
          <span className="text-gray-700">·</span>
          <Link href="/privacy" className="text-gray-600 hover:text-gray-400 transition-colors text-xs">מדיניות פרטיות</Link>
        </div>
        <Link
          href="/admin/login"
          className="inline-flex items-center gap-1.5 mt-3 text-gray-600 hover:text-gray-400 transition-colors text-xs"
        >
