    ...
    <div className="min-h-screen bg-party-bg py-12 px-4" dir="rtl">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-party-surface border border-party-border rounded-3xl p-8 space-y-8 text-gray-300 text-sm leading-relaxed">
          ...
          <section className="space-y-2">
            <h2 className="text-white font-bold text-base">3. תשלום</h2>
            <p>העלות היא 499 ₪ לאירוע, תשלום חד פעמי. אין מנוי ואין חיובים נסתרים. התשלום מתבצע בטרם יצירת האירוע.</p>
          </section>

          <section className="space-y-2 bg-amber-500/5 border border-amber-500/20 rounded-2xl p-4">
            <h2 className="text-amber-300 font-bold text-base">4. מדיניות ביטול והחזרים</h2>
            <ul className="space-y-2 list-disc list-inside">
              ...
              <li>לפניות בנושא ביטולים: <a href="mailto:clink.support@gmail.com" className="text-yellow-400 underline">clink.support@gmail.com</a></li>
            </ul>
          </section>

          <section className="space-y-2">
            <h2 className="text-white font-bold text-base">5. תוכן ואחריות</h2>
          ...
          <section className="space-y-2">
            <h2 className="text-white font-bold text-base">6. קניין רוחני</h2>
            <p>התמונות והסרטונים שהועלו שייכים לבעליהם המקוריים. Clink אינה רוכשת בעלות על תוכן שהועלה לפלטפורמה.</p>
          </section>

          <section className="space-y-2">
            <h2 className="text-white font-bold text-base">7. הגבלת אחריות</h2>
            <p>Clink אינה אחראית לאובדן תמונות עקב תקלות טכניות מעבר לשליטתה. מומלץ לשמור עותקים מקומיים של קבצים חשובים.</p>
          </section>

          <section className="space-y-2">
            <h2 className="text-white font-bold text-base">8. יצירת קשר</h2>
            <p>לכל שאלה: <a href="mailto:clink.support@gmail.com" className="text-yellow-400 underline">clink.support@gmail.com</a></p>
          </section>

        </div>

        <div className="text-center mt-6">
          <Link href="/privacy" className="text-gray-500 text-xs hover:text-gray-400 transition-colors underline">
            מדיניות פרטיות
          </Link>
        </div>
      </div>
